        ...
        <div class="row">
                ...
                <form action="#" class="p-5 bg-white">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Rašykite savo klausimus ar pastebėjimus čia..."></textarea>
                        </div>
                    </div>

                    <div class="row form-group">
                        <div class="col-md-12">
                            <input type="submit" value="Siųsti žinutę" class="btn btn-primary py-2 px-4 text-white">
                        </div>
                    </div>
            ...
            <div class="col-md-5"  data-aos="fade" data-aos-delay="100">
                ...
                <div class="p-4 mb-3 bg-white">
                    ...
                    <p class="mb-4">Kaunas</p>

                    <p class="mb-0 font-weight-bold">Telefonas</p>
                    <p class="mb-4"><a href="#">+3706225566</a></p>

                    <p class="mb-0 font-weight-bold">El pašto adresas</p>
                ...
                <div class="p-4 mb-3 bg-white">
                    ...
                    <p><a href="#" class="btn btn-primary px-4 py-2 text-white">Skaityti daugiau</a></p>
                </div>
